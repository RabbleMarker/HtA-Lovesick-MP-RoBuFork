...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_DAYS_DELAY = 3, -- delay in days before the STR will get damage due to no supplies. Sometimes supply status may jump bcoz of the market.
...
diplomacy = {
	...
	GW_WARSCORE_2_THRESHOLD = 0, -- warscore threshold where a GW turns into a world war for winner side
	TENSION_DECAY = -10000,
